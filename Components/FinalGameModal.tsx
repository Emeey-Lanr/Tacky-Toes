      ...
      <div>
        ...
        <div className="w-96 h-11 bg-black flex justify-between px-1 items-center my-2 rounded-sm">
         ...
         <div className="w-96 h-11">
                  <button onClick={()=>buttonNavigation(`${isOwner === 0 ? `${gameDetails.creator}`:`${gameDetails.versus}` }`)} className='rounded-sm border w-full h-full font-bold text-gray-700 hover:bg-black hover:rounded-md hover:text-white '>
                    Next
                  </button>  
         </div>
